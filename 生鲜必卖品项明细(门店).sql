...
select b.NodeCode ColonyCode,b.NodeName ColonyName,a.CategoryCode,a.goodscode,a.GoodsName,a.ProdArea,a.GoodsSpec,a.BaseMeasureUnit,a.BaseBarCode,a.IsMust from 

(select distinct NodeCode,NodeName from 
TB部门信息表 A 
