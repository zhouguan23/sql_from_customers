...
and (CategoryCode like '1%' or CategoryCode like '3%')
...
SET @SQL2=''
SELECT @SQL2=@SQL2+' UNION ALL SELECT * FROM '+[name]A+' where EnterAccountDate between '+@qsrq+' and '+@dqrq+' and CategoryItemCode =''0001'' and CategoryLevel=1
...
and (GoodsCatCode like ''1%''  or  GoodsCatCode like ''3%'')
