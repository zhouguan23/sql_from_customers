select   count(1) week1  from  cust cc where status='02' 
${if(len(slsmanid)==0," and cc.dpt_sale_id='17080100' "," and cc.slsman_id='"+slsmanid+"'")}
and  call_period=1
...
count(1)custjs from co_cust cc   where   status='02'

${if(len(slsmanid)==0," and cc.sale_dept_id='11371708' "," and cc.slsman_id='"+slsmanid+"'")}
...
${if(len(slsmanid)==0," and cc.sale_dept_id='11371708' "," and cc.slsman_id='"+slsmanid+"'")}
 group by cust_type3,domain_id
) group by cust_type3,dingh

select dict_key,dict_value from base_dict where dict_id='CO_CUST_CUST_TYPE3_SD'

select   count(1) week2  from  cust cc where status='02'
${if(len(slsmanid)==0," and cc.dpt_sale_id='17080100' "," and cc.slsman_id='"+slsmanid+"'")}
and  call_period=2

select   count(1) week3  from  cust cc where status='02' 
${if(len(slsmanid)==0," and cc.dpt_sale_id='17080100' "," and cc.slsman_id='"+slsmanid+"'")}
and  call_period=3

select   count(1) week4  from  cust cc where status='02' 

${if(len(slsmanid)==0," and cc.dpt_sale_id='17080100' "," and cc.slsman_id='"+slsmanid+"'")}
and  call_period=4

select   count(1) week5  from  cust cc where status='02' 
${if(len(slsmanid)==0," and cc.dpt_sale_id='17080100' "," and cc.slsman_id='"+slsmanid+"'")}
and  call_period=5
...
${if(len(slsmanid)==0," and cc.sale_dept_id='11371708' "," and cc.slsman_id='"+slsmanid+"'")}
 and a.date1='${date1}' group by kind
...
,co_cust cc
where a.item_id=i.item_id 
 and date1=(select to_char(add_months(to_date('${date1}','yyyyMM'),-13),'yyyyMM') from dual) and  a.cust_id=cc.cust_id
${if(len(slsmanid)==0," and cc.sale_dept_id='11371708' "," and cc.slsman_id='"+slsmanid+"'")}
)
...
,plm_item i ,co_cust ct where a.item_id=i.item_id 

${if(len(slsmanid)==0," and ct.sale_dept_id='11371708' "," and ct.slsman_id='"+slsmanid+"'")}
...
where cc.born_date like '${date1}%' and  cc.cust_id=ct.cust_id
...
where  cc.cust_id=ct.cust_id and born_date>=(select to_char(add_months(to_date('${date1}','yyyyMM'),-1),'yyyyMM')||'01' from dual)
 and born_date<=(select to_char(add_months(to_date('${date1}','yyyyMM'),-1),'yyyyMM')||'31' from dual) 
...
ccc.cust_id=ct.cust_id  and born_date like '${date1}%' 
