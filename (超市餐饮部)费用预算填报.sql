...
含税分课预算表
where CategoryItemCode='0002' and CategoryCode like '23%'
...
tb预算科目表 a 
left join 
tb预算科目表 b on b.CategoryLevel='2' and a.CategoryCode=b.ParentCategoryCode and b.CategoryItemCode='0004'
where a.CategoryLevel='1' and a.CategoryItemCode='0004'
)a,
...
tb预算科目表 a 
left join 
tb预算科目表 b on b.CategoryLevel='2' and a.CategoryCode=b.ParentCategoryCode  and b.CategoryItemCode='0005'
where a.CategoryLevel='1' and a.CategoryItemCode='0005'
)a,
