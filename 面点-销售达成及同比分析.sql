...
含税分课预算表
where(DeptCode   LIKE '1%' OR DeptCode   LIKE '2%')  and CategoryItemCode='0000' and (CategoryCode like '21%' or CategoryCode like '281%' or  CategoryCode like '288%' )
...
and (CategoryCode like ''21%'' or CategoryCode like ''281%'' OR CategoryCode like ''288%'' )
