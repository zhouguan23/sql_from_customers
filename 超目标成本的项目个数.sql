...
from
(
select AREA_ORG_CODE,AREA_ORG_NAME,CITY_ORG_CODE,CITY_ORG_NAME,PROJ_NAME,PROJ_CODE,
sum(DC_OBJ_COST_AMT) as DC_OBJ_COST_AMT,
sum(DC_DYN_COST_AMT) as DC_DYN_COST_AMT,
sum(DC_DIFF_AMT) as DC_DIFF_AMT,
sum(DC_DIFF_AMT)/sum(DC_OBJ_COST_AMT)*100 as DIFF_RATE,
...
group by AREA_ORG_CODE,AREA_ORG_NAME,CITY_ORG_CODE,CITY_ORG_NAME,PROJ_NAME,PROJ_CODE,aa
