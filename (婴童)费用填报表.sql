...
tb预算科目表 a 
left join 
tb预算科目表 b on b.CategoryLevel='2' and a.CategoryCode=b.ParentCategoryCode and b.CategoryItemCode in ('0002','0003')
where a.CategoryLevel='1' and a.CategoryItemCode in ('0002','0003')
)a,
...
a.Category1Code,a. Category1Name,A.CategoryCode,A.CategoryName,a.YM,a.NodeCode,a.NodeName,isnull(b.Salesindex,0)salesindex from
(select a.CategoryItemCode,a.Category1Code, Category1Name,A.CategoryCode,A.CategoryName,B.YM,c.NodeCode,c.NodeName from 
(SELECT '0002' CategoryItemCode,'0'Category1Code,'税收'Category1Name,'0001'CategoryCode,'所得税'CategoryName
union all 
SELECT '0002' CategoryItemCode,'0'Category1Code,'税收'Category1Name,'0002'CategoryCode,'增值税'CategoryName
)a,
