select a.PromotionThemeCode,a.PromotionPeriodCode,a.PromotionPeriodName,a.BeginDate,a.EndDate,a.CategoryCode,a.CategoryName,count(distinct 商品编码)SKU,count(distinct case when 单据状态 not in ('11','0','1') then  商品编码 else null end )已审SKU from 
