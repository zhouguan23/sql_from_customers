...
select c.union_area_name,d.cus_code,d.cus_name,d.open_date,d.close_date,b.age_store,sum(dst.no_tax_amount)as 销售额,
(sum(dst.no_tax_amount)-sum(dst.no_tax_cost)) as 毛利额,
sum(fst.subtotal_of_expenses)as 费用额,
...
from dim_region c,dim_cus d,dim_cus_ybd a
left join age_store b
...
group by c.union_area_name,d.cus_code,d.cus_name,d.open_date,d.close_date,b.age_store
order by min(c.sorted),d.cus_code
