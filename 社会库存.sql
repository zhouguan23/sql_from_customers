...
case when t.jykcyc='1' then '卷烟库存异常信息' else '' end as "jykcycName" ,
case when t.jyxsyc='1' then '卷烟销售异常信息' else '' end as "jyxsycName",
...
${if(len(jykcyc)==0,"",if(jykcyc==true,"and t.jykcyc='1'",""))}
${if(len(jyxsyc)==0,"",if(jyxsyc==true,"and t.jyxsyc='1'",""))}
