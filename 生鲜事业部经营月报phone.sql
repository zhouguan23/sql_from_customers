...
TB部门信息表 A
LEFT JOIN 
含税分课预算表 B ON A.NodeCode=b.DeptCode and BudgetYM between convert(varchar(6),dateadd(dd,0,'${qsrq}'),112) and   convert(varchar(6),dateadd(dd,0,'${dqrq}'),112) and CategoryItemCode in ('0000')
