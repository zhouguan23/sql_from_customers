...
case when t.xys='1' then '吸烟室设施损毁、缺失' else '' end as "xysName" ,
case when t.xyd='1' then '吸烟点设施损毁、缺失' else '' end as "xydName",
...
${if(len(xyd)==0,"",if(xyd==true,"and t.xyd='1'",""))}
${if(len(xys)==0,"",if(xys==true,"and t.xys='1'",""))}
