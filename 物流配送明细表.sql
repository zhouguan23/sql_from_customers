...
where case when CategoryCode not like '1%' or CategoryCode not like '2%' then a.PerformAmount else a.PerformMoney end >0
and  case when CategoryCode not like '1%' or CategoryCode not like '2%' then a.PerformAmount else a.PerformMoney end <  case when CategoryCode not like '1%' or CategoryCode not like '2%' then a.Amount else a.PurchMoney end and LEFT(BuildDate,8)  <='${rq}' 
