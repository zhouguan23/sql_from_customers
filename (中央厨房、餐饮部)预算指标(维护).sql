...
round(case when a.CategoryCode in (11,13,14) then b.Salesindex/1.1 when a.CategoryCode in (10,12) then b.Salesindex/1  when a.CategoryCode in (640,23) then b.Salesindex/1.06  else b.Salesindex/1.16 end,2) TaxSalesindex,
round(case when a.CategoryCode in (11,13,14) then (b.Salesindex/1.1)*(case when b.Grossprofitindex=0 or b.Salesindex=0 then 0 else   b.Grossprofitindex/b.Salesindex end ) 
 ...
 when a.CategoryCode in (640,23) then (b.Salesindex/1.06)*(case when b.Grossprofitindex=0 or b.Salesindex=0 then 0 else   b.Grossprofitindex/b.Salesindex end ) 
