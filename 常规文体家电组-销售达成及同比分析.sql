...
and (CategoryCode like '44%' or CategoryCode like '45%' or CategoryCode like '48%' 
  or CategoryCode like '49%')
...
and (CategoryCode like ''44%''  or  CategoryCode like ''45%'' or  CategoryCode like ''48%'' or  CategoryCode like ''49%'')
...
and (GoodsCatCode like ''44%''  or  GoodsCatCode like ''45%''  or  GoodsCatCode like ''48%''  or  GoodsCatCode like ''49%'')
...
(select nodecode ,sum(SaleIncome+saletax)SaleMoney from 
 ('+@SQL1+')  a,tb商品档案 b 
WHERE a.goodscode=b.goodscode  and  (nodecode LIKE ''1%'' OR nodecode LIKE ''2%'' ) 
and (CategoryCode like ''44%''  or  CategoryCode like ''45%'' or  CategoryCode like ''48%'' or  CategoryCode like ''40%'')
GROUP BY nodecode)b on a.nodecode= b.nodecode
