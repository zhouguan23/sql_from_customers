...
case when t.wfwg='1' then '违法、违规案件' else '' end as "wfwgName" ,
case when t.jywl='1' then '卷烟外流信息' else '' end as "jywlName",
case when t.zdbdb='1' then '终端不达标信息' else '' end as "zdbdbName",
...
${if(len(jywl)==0,"",if(jywl==true,"and t.jywl='1'",""))}
${if(len(zdbdb)==0,"",if(zdbdb==true,"and t.zdbdb='1'",""))}
