...
when (CategoryCode like ''14%'' or CategoryCode like ''30%'' or CategoryCode like ''31%'' or CategoryCode like ''32%'' or CategoryCode like ''33%'')  then ''30''
...
else CategoryCode end CategoryName,SUM(SaleAmount)SaleAmount
