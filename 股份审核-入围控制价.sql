...
${ if(INARRAY("4", SPLIT(show, ",")) = 0,"","projn,STAGE_NAME," ) }
...
${ if(INARRAY("10", SPLIT(show, ",")) = 0,"","EVALUATION_BID_METHOD_NAME," ) }
...
${ if(INARRAY("16", SPLIT(show, ",")) = 0,"","PROD_TYPE_DES," ) }
${ if(INARRAY("17", SPLIT(show, ",")) = 0,"","if_COOP," ) }
${ if(INARRAY("18", SPLIT(show, ",")) = 0,"","CHOSEN_REASON," ) }
${ if(INARRAY("1", SPLIT(show, ",")) = 0,"","AREA_ORG_CODE," ) } 
${ if(INARRAY("2", SPLIT(show, ",")) = 0,"","CITY_ORG_CODE," ) }
${ if(INARRAY("3", SPLIT(show, ",")) = 0,"","PROJ_CODE," ) } 
${ if(INARRAY("4", SPLIT(show, ",")) = 0,"","projc,STAGE_CODE," ) }
aa,
...
${ if(INARRAY("2", SPLIT(show, ",")) = 0,"","CITY_ORG_NAME," ) }
${ if(INARRAY("3", SPLIT(show, ",")) = 0,"","PROJ_NAME," ) } 
${ if(INARRAY("4", SPLIT(show, ",")) = 0,"","PROJ_NAME as projn,STAGE_NAME," ) }
${ if(INARRAY("5", SPLIT(show, ",")) = 0,"","OBJECT_NAME," ) } 
${ if(INARRAY("6", SPLIT(show, ",")) = 0,"","SUP_TYPE_NAME," ) }
${ if(INARRAY("7", SPLIT(show, ",")) = 0,"","PROC_MODE_NAME," ) } 
${ if(INARRAY("8", SPLIT(show, ",")) = 0,"","PROC_WAY_NAME," ) } 
...
${ if(INARRAY("2", SPLIT(show, ",")) = 0,"","CITY_ORG_CODE," ) }
${ if(INARRAY("3", SPLIT(show, ",")) = 0,"","PROJ_CODE," ) } 
${ if(INARRAY("4", SPLIT(show, ",")) = 0,"","PROJ_CODE as projc,STAGE_CODE," ) }
LIMIT_MONEY,'' as aa
from 
(select * from f_po_supplier_object where 1=1 
...
${if(len(SFHZXM) == 0,"","and if_COOP in ('" + SFHZXM + "')")}
)a
...
SELECT distinct  ENTITY_ORG_NAME  from f_po_setbid
...
select distinct CATEGORY_NAME FROM f_po_supplier_object
where CATEGORY in (select sap_DEPT_ID from user_org where ORG_TYPE='立项分类' )


select distinct  ZGFZD_CLASS_DESC from  f_po_supplier_object
where 1=1
${if(len(ZGFZD) == 0,"","and ZGFZD in ('" + ZGFZD + "')")}
...
SELECT DISTINCT if_COOP FROM f_po_supplier_object
