select * from 
(select ${ll_groupby},a.trantypeid,a.trantypename,a.nextdate,
...
and v.uncarticlasscode = '"+ls_uncarticlasscode+"') ")}
...
${if(len(ll_catagory)==0,"","and e.com_goods_catagory_id in ("+ll_catagory+")")}
 ...
 group by ${ll_groupby},b.party_opcode,b.party_name,a.nextdate,
...
select b.stkcellid,a.shortname ||'-'|| b.stkcellno as stkcellname
