...
含税分课预算表
where CategoryItemCode='0002' and CategoryCode not like '23%'
and BudgetYM between '${qsrq}' and '${jsrq}'
...
tb预算科目表 a 
left join 
tb预算科目表 b on b.CategoryLevel='2' and a.CategoryCode=b.ParentCategoryCode and b.CategoryItemCode='0006'
where a.CategoryLevel='1' and a.CategoryItemCode='0006'
)a,
...
tb预算科目表 a 
left join 
tb预算科目表 b on b.CategoryLevel='2' and a.CategoryCode=b.ParentCategoryCode and b.CategoryItemCode='0007'
where a.CategoryLevel='1' and a.CategoryItemCode='0007'
)a,
