...
前30天销量 前30天销量,前30天销售收入+前30天销售税金 前30天销售额,前30天含税销售毛利 前30天毛利额,
前3月销量 前3月销量,前3月销售收入+前3月销售税金 前3月销售额,前3月含税销售毛利 前3月毛利额,
库存数量,含税库存成本  from 
dbo.TB${YM}_报表数据源 a 
left join 
TBREPORTPARADEFINE b on left(五级分类编码,4) like b.goodscode 
...
and  exists  ( select * from TBGOODSPROPINCLUSIONS c where a.商品编码=c.goodscode and c.GoodsPropertyCode='2001')
