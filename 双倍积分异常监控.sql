...
,a.BillNumber,a.PosNo,a.IntegralValue,a.SaleMoney,b.SellCashierCode,b.SellCashierName,c.GoodsCode,d.GoodsName,d.GoodsType
,c.ScoreMulti
,c.IntegralValue
,c.SaleAmount
...
where a.SaleMoney>='+@je+' and a.IntegralValue>0 and b.SaleTag=0 and b.IsOutRule=0 and exists(select * from 
('+@sql3+') z where a.DepartmentCode=z.DeptCode and a.BillNumber=z.BillNumber and z.ScoreMulti>1)
