...
and qh.date1<=(SELECT TO_CHAR(add_months(to_date('${date2}','yyyyMM'),-12),'yyyyMM') FROM DUAL)  group by qh.sale_dept_id, i.kind,ic.is_prm,is_thin,yieldly_type,tar_cont,is_key_brd,i.brand_id,ic.pri_rtl
