...
GROUP BY BUYERAREANAME,AREANAME,CATN,PROVINCE
...
GROUP BY  BUYERAREANAME,  A.AREANAME,A.CATN,A.PROVINCE) D

LEFT JOIN 

(SELECT
	SUM(QTY)/10000 AS QTY,ROUND(SUM(TOTAL_PRICE)/10000,2) AS TOTAL_PRICE,BUYERAREANAME,AREANAME,CATN,PROVINCE
FROM
	DW_DEPT_SALE
WHERE 1=1
${if(len(ZL) == 0,"","and STRATEGICCHANNEL in ('" + ZL + "')")}
...
${if(len(ZL) == 0,"","and STRATEGICCHANNEL in ('" + ZL + "')")}
${if(len(CHANNEL_TYPE) == 0,"","and CHANNEL_TYPE in ('" + CHANNEL_TYPE + "')")}
${if(len(BUYERAREANAME) == 0,"","and BUYERAREANAME in ('" + BUYERAREANAME + "')")}	${if(len(MANAGEMENT_MODEL) == 0,"","and MANAGEMENT_MODEL in ('" + MANAGEMENT_MODEL + "')")}
