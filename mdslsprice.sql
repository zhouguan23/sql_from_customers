...
and cc.sale_dept_id='${dptid}'group by slsman_id
...
where sls.dpt_sale_id=dp.dpt_sale_id  and dp.sale_dept_id='${dptid}' order by dp.dpt_sale_id_new,slsman_id

select * from hz_custfd where date1='201509'
