...
select distinct b.goods_code, C.goods_code||'|'||C.goods_name goods_name
...
select area_code,goods_Code,count(*) from 
(select  A.area_code,b.goods_code,A.cus_code
from DIM_CUS C,dm_stock_shop_detail A left join dim_disable_code B 
