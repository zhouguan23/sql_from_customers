...
from master..spt_values a ,TB部门信息表 b
where type='p' and number <= datediff(dd,dateadd(dd,-day('${dqrq}')+1,'${dqrq}')   ,dateadd(ms,-3,DATEADD(mm, DATEDIFF(m,0,'${dqrq}')+1, 0)))
and (NodeCode  LIKE '9%') AND LEN(AreaCode)>0
...
(select nodecode,occurdate,sum(SaleIncome+saletax)SaleMoney,sum(TaxSaleGrossProfit)TaxSaleGrossProfit  from 
tb${YM}_GoodsDAYpssm a,tb商品档案 b 
WHERE a.goodscode=b.goodscode  and  (NodeCode  LIKE '9%') 
 and occurdate = convert(varchar(8),dateadd(dd,0,'${dqrq}'),112) 
...
where a.goodscode=b.goodscode  and  (DeptCode   LIKE '9%') 
...
left join 
(select nodecode,
sum(PURCHCOST+PurchTax + REDEPLOYINCOST+RedeployinTax + PROFITCOST+ProfitCost + COUNTPROFITCOST+CountProfitTax - TaxSaleCost  - REDEPLOYOUTCOST-RedeployoutTax - LOSSCOST-LossTax - COUNTLOSSCOST-CountLossTax-ToGiftCost-ToGiftTax )StockCost  from 
tb${YM}_Goodsdaypssm a,tb商品档案 b 
WHERE a.goodscode=b.goodscode  and  (NodeCode  LIKE '9%')
 and occurdate <= convert(varchar(8),dateadd(dd,0,'${dqrq}'),112) 
...
left join 
TB${YM}_门店客单客流 b on  a.NodeCode =b.DeptCode     and a.defday=b.EnterAccountDate  and b.CategoryItemCode='0000' and b.CategoryLevel='2' and b.GoodsCatCode like '64'
where  a.defday=convert(varchar(8),dateadd(dd,0,'${dqrq}'),112) 
group by AreaCode,NodeCode ,a.defday
...
tb${YM}_GoodsDAYpssm a,tb商品档案 b 
WHERE a.goodscode=b.goodscode  and  (NodeCode  LIKE '9%')  
and b.CategoryCode not like '64%'
 and occurdate = convert(varchar(8),dateadd(dd,0,'${dqrq}'),112) 
GROUP BY nodecode,occurdate
UNION all
...
left join 
(select nodecode,
sum(PURCHCOST+PurchTax + REDEPLOYINCOST+RedeployinTax + PROFITCOST+ProfitCost + COUNTPROFITCOST+CountProfitTax - TaxSaleCost  - REDEPLOYOUTCOST-RedeployoutTax - COUNTLOSSCOST-CountLossTax- LOSSCOST-LossTax -ToGiftCost-ToGiftTax )StockCost  from 
tb${YM}_Goodsdaypssm a,tb商品档案 b 
WHERE a.goodscode=b.goodscode  and  (NodeCode  LIKE '9%')
and b.CategoryCode not like '64%'
 and occurdate <= convert(varchar(8),dateadd(dd,0,'${dqrq}'),112) 
...
left join 
TB${YM}_门店客单客流 b on  a.NodeCode =b.DeptCode     and a.defday=b.EnterAccountDate  and b.CategoryItemCode='0000' and b.CategoryLevel='2' and b.GoodsCatCode not like '64'
where  a.defday=convert(varchar(8),dateadd(dd,0,'${dqrq}'),112) 
group by AreaCode,NodeCode ,a.defday
...
left join 
TB${YM}_门店客单客流 b on  a.NodeCode =b.DeptCode     and a.defday=b.EnterAccountDate  and b.CategoryItemCode='0000' and b.CategoryLevel='3' and left(b.GoodsCatCode,3) in('610','611','612')
where  a.defday=convert(varchar(8),dateadd(dd,0,'${dqrq}'),112) 
group by AreaCode,NodeCode ,a.defday
...
tb${YM}_GoodsDAYpssm a,tb商品档案 b 
WHERE a.goodscode=b.goodscode  and  (NodeCode  LIKE '9%')  
and left(b.CategoryCode,3) in('610','611','612')
 and occurdate = convert(varchar(8),dateadd(dd,0,'${dqrq}'),112) 
GROUP BY nodecode,occurdate
UNION all
...
(DeptCode   LIKE '9%')  
and CategoryItemCode='0000'
and left(CategoryCode,3) in ('610','611')
and BudgetYM  between convert(varchar(6),dateadd(dd,0,'${dqrq}'),112) and convert(varchar(6),dateadd(dd,0,'${dqrq}'),112)
group by DeptCode)c on a.NodeCode=c.DeptCode 
...
left join 
TB${YM}_门店客单客流 b on  a.NodeCode =b.DeptCode     and a.defday=b.EnterAccountDate  and b.CategoryItemCode='0000' and b.CategoryLevel='3' and left(b.GoodsCatCode,3) in('610','612','614','615','616','617','618','620')
where  a.defday=convert(varchar(8),dateadd(dd,0,'${dqrq}'),112) 
group by AreaCode,NodeCode ,a.defday
...
tb${YM}_GoodsDAYpssm a,tb商品档案 b 
WHERE a.goodscode=b.goodscode  and  (NodeCode  LIKE '9%')  
and left(b.CategoryCode,3) in('610','612','614','615','616','617','618','620')
 and occurdate = convert(varchar(8),dateadd(dd,0,'${dqrq}'),112) 
GROUP BY nodecode,occurdate
UNION all
...
(DeptCode   LIKE '9%')  
and CategoryItemCode='0000'
and left(CategoryCode,3) in ('610','620')
and BudgetYM  between convert(varchar(6),dateadd(dd,0,'${dqrq}'),112) and convert(varchar(6),dateadd(dd,0,'${dqrq}'),112)
group by DeptCode)c on a.NodeCode=c.DeptCode 
...
left join 
TB${YM}_门店客单客流 b on  a.NodeCode =b.DeptCode     and a.defday=b.EnterAccountDate  and b.CategoryItemCode='0000' and b.CategoryLevel='3' and left(b.GoodsCatCode,3) in('611','621')
where  a.defday=convert(varchar(8),dateadd(dd,0,'${dqrq}'),112) 
group by AreaCode,NodeCode ,a.defday
...
tb${YM}_GoodsDAYpssm a,tb商品档案 b 
WHERE a.goodscode=b.goodscode  and  (NodeCode  LIKE '9%')  
and left(b.CategoryCode,3) in('611','621')
 and occurdate = convert(varchar(8),dateadd(dd,0,'${dqrq}'),112) 
GROUP BY nodecode,occurdate
UNION all
...
(DeptCode   LIKE '9%')  
and CategoryItemCode='0000'
and left(CategoryCode,3) in ('611','621')
and BudgetYM  between convert(varchar(6),dateadd(dd,0,'${dqrq}'),112) and convert(varchar(6),dateadd(dd,0,'${dqrq}'),112)
group by DeptCode)c on a.NodeCode=c.DeptCode 
