--当期销售
select b.union_area_name,m.small_cate,m.large_cate,g.goods_code,g.goods_name,g.specification,g.manufacturer,g.bar_code,g.category,g.sub_category,
min(b.sorted) sorted,
...
group by b.union_area_name,m.small_cate,m.large_cate,g.goods_code,g.goods_name,g.specification,g.manufacturer,g.bar_code,g.category,g.sub_category
order by sorted,g.goods_code
