...
case when t.zdjs='1' then '终端建设' else '' end as "zdjsName" ,
case when t.pppy='1' then '品牌培育' else '' end as "pppyName",
case when t.xxcj='1' then '信息采集' else '' end as "xxcjName",
...
${if(len(zdjs)==0,"",if(zdjs==true,"and t.zdjs='1'",""))}
${if(len(pppy)==0,"",if(pppy==true,"and t.pppy='1'",""))}
${if(len(xxcj)==0,"",if(xxcj==true,"and t.xxcj='1'",""))}
