...
and i.item_id in 
( select distinct item_id from pi_com_item_day@hzyx.us.oracle.com where 
date1='${date1}'
)
 
order by ic.pri_wsale  desc,f.brdowner_id ,i.brand_id,kind asc
...
select i.item_id,
qty_sold_month*t_size/50000 qtymonth,
amt_sold_month  amt_sold_month,
gross_sold_month  gross_sold_month,

qty_sold_month_same*t_size/50000 qtymonthsame,
  amt_sold_month_same ,
  gross_sold_month_same,

qty_sold_year*t_size/50000 qtyyear ,
amt_sold_year  amt_sold_year,
gross_sold_year/10000  yearml,

qty_sold_year_same*t_size/50000 qtyyearsame,
amt_sold_year_same  amt_sold_year_same,
gross_sold_year_same  gross_sold_year_same
