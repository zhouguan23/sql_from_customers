...
case when w.rim_kind='11' then '70' 
when w.rim_kind='12' then (case when w.cust_type3='011' then '53' when w.cust_type3='012' or w.cust_type3='013' then '53' when w.cust_type3='023' or w.cust_type3='024' then '30' else '未知' end) 
when w.rim_kind='13' then (case when w.cust_type3='011' then '35' when w.cust_type3='012' or w.cust_type3='013' then '28' when w.cust_type3='023' or w.cust_type3='024' then '22' else '未知' end)  
else '未知' end)
else '16' end as rim_kind_number,
w.busi_addr,
depa.DPT_SALE_NAME,
...
where 1=1
and w.license_code not in ('371702105429','371702105406')
