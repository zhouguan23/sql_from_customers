...
含税分课预算表
where(DeptCode   LIKE '1%' OR DeptCode   LIKE '2%')  and CategoryItemCode='0000' and (CategoryCode like '20%' OR CategoryCode like '280%' OR CategoryCode like '287%' OR CategoryCode like '29%')
...
and (CategoryCode like ''20%'' OR CategoryCode like ''280%'' OR CategoryCode like ''287%'' OR CategoryCode like ''29%'')
