...
SELECT DISTINCT T1.quarter_name,ORG_ID,SMART_SHORTNAME,
CONST_AREA/10000 as CONST_AREA -- 在建面积（操盘+代建）
,CONST_AREA_JOINT/10000 as CONST_AREA_JOINT -- 包含联合操盘在建面积
,LEVEL,SMART_ORGNO_FULLPATH,SMART_ORDER
FROM f_ehr_org_struc A 
inner JOIN T1 on 1=1
LEFT JOIN ipt_hr_const_area_copy1 B
...
ORDER BY quarter_name,LEVEL,SMART_ORDER,SMART_ORGNO_FULLPATH
