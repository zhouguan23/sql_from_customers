...
TB分类对照表 a
where a.CategoryLevel ='2' and a.CategoryItemCode='0002' and left(ParentCategoryCode,1) not in (1,2,6)
union all 
select '7' ParentCategoryCode,'7'+CategoryCode ,'7'+CategoryCode,case when CategoryCode='30' then '食品' when CategoryCode='40' then '家居' when CategoryCode='46' then '家纺' when CategoryCode='50' then '日化' end CategoryName from 
TB商品分类表
...
tb部门信息表
where (nodecode like '1%' or nodecode like '2%') and OpenDate<= '${qsrq}'+'01' 
...
TB分类对照表 
union all 
select '0001'CategoryItemCode,'7'CategoryCode,'自有品牌' CategoryName,
'0' ParentCategoryCode,'1'CategoryLevel
union all 
select CategoryItemCode,'7'+CategoryCode,case when CategoryCode='30' then '食品' when CategoryCode='40' then '家居' when CategoryCode='46' then '家纺' when CategoryCode='50' then '日化' end CategoryName,
