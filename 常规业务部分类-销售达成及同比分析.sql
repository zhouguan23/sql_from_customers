...
含税分课预算表
where(DeptCode   LIKE '1%' OR DeptCode   LIKE '2%')  and CategoryItemCode='0000' and (CategoryCode like '3%' or CategoryCode like '4%' or CategoryCode like '5%')
...
and b.CategoryCode not like ''35%''
