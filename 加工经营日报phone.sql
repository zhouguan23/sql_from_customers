...
WHERE  (a.NodeCode LIKE ''1%'' or a.NodeCode LIKE ''2%'')   and CategoryCode like ''2%'' and CategoryCode not like ''28'' and State!=2
...
set @jsny=@dqrq
SET @SQL=''
SELECT @SQL=@SQL+' UNION ALL SELECT * FROM '+[name]A+' where occurdate = '+@dqrq+'' 
