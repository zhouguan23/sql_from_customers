select a.NodeCode,left(b.CategoryCode,2)CategoryCode2,a.StartAmount,(a.StartCost+a.StartTax)qccb,a.PurchAmount,(a.PurchCost+a.PurchTax)jhcb,a.ProfitAmount,(a.ProfitCost+a.ProfitTax)sycb,b.CategoryCode,a.goodscode,b.GoodsName,b.BaseBarCode ,b.BaseMeasureUnit,b.GoodsType,c.SupplierCode+' '+c.SupplierName SupplierCode,
...
left join 
[000]A .tbGoods b on a.GoodsCode =b.GoodsCode and b.GoodsType in (0,2) and left(b.CategoryCode,1) between 6 and 9
left join 
...
order  by a.NodeCode,a.TaxSaleGrossProfit
