...
plm_item i ,factory f,item_goujin a,item_com ic
 ...
 where f.fact_id=i.brdowner_id and i.item_id=a.item_id 　and years='2014'
...
PI_CONTRACT_LINE   pl 
 where p.contr_num=pl.contr_num and p.pose_date>='20140701' and pose_date<='20141231' 
group by item_id 
...
crt_date>='20140701' and crt_date<='20141231' group by item_id
